    ...
    <div className=' w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
      ...
      <div className=' bg-[#121212] h-[85%] rounded flex flex-col '>
        <div className=' p-4 flex items-center justify-between'>
          ...
          <img src={assets.arrow_icon} className='w-5 hover:scale-110' alt="" />
          <img src={assets.plus_icon} className='w-5 hover:scale-110' alt="" />
          </div>
        </div>
        ...
        <div className=' bg-[#242424] p-4 m-2 flex gap-2 flex-col content-center rounded items-start font-semibold '>
          ...
          <button className='px-4 py-1.5 bg-white text-black rounded-full mt-4 shadow-md hover:scale-105'>Create playlist</button>
        </div>
